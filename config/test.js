...
const passportConfigAuthorizedResponse = {
  ...
  providers: [
    ...
    },
    {
      ...
      enabled: true,
      callbackUrl:
        "https://chris.gluuthree.org/passport/auth/saml/saml-emailreq/callback",
    ...
    },
    {
      ...
      enabled: true,
      callbackUrl:
        "https://chris.gluuthree.org/passport/auth/saml/saml-emaillink/callback",
      requestForEmail: false,
    ...
    },
    {
      ...
      enabled: true,
      callbackUrl:
        "https://chris.gluuthree.org/passport/auth/saml/saml-yidpinitiated/callback",
      requestForEmail: false,
      emailLinkingSafe: false,
      options: {
        skipRequestCompression: "true",
    ...
    },
    {
      ...
      enabled: true,
      callbackUrl:
        "https://gluu.test.ce6.local.org/passport/auth/oidccedev6/callback",
      requestForEmail: false,
      emailLinkingSafe: false,
      options: {
    ...
    },
    {
      ...
      enabled: true,
      callbackUrl:
        "https://gluu.test.ce6.local.org/passport/auth/oidccedev6privatejwt/callback",
      requestForEmail: false,
      emailLinkingSafe: false,
      options: {
        client_id: "b4e0f241-a8c1-4c75-8fc8-4ae7163e9695",
    ...
    },
    {
      ...
      enabled: true,
      callbackUrl:
        "https://gluu.test.ce6.local.org/passport/auth/oidccedev6_pkce/callback",
      requestForEmail: false,
      emailLinkingSafe: false,
      options: {
